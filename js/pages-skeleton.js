...
var maxScroll = document.documentElement.scrollTop + document.documentElement.clientHeight;
var deviceType;
...
setInterval(function() {
    ...
    if ((timeSpentOnPage - previousTime) > 9.9) {
        //timestamps.push({'ts': Date.now(), 'i': Math.round(timeSpentOnPage)});
...
jQuery(document).ready(function () {
    ...
    var backgroundsLazyload = new LazyLoad({
        ...
        callback_reveal  : function (el) {
            ...
            if ($backgroundImage.hasClass(
                'kartra_parallax_background') && 'undefined' !== typeof window['kartra']['customParallax']) {
