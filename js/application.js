      ...
      if (typeof window['onMessage_frame'] !== 'function') {
        window['onMessage_frame'] = function (messageEvent) {
            ...
            if(typeof(messageEvent.data) !== 'undefined' && messageEvent.data["func"] == 'resize') {
                jQuery('[id="checkout_frame_'+messageEvent.data["pop"]+'"]').css('height',messageEvent.data["height"]+'px');
                jQuery('[id="checkout_frame_'+messageEvent.data["pop"]+'"]').parent().css('height',messageEvent.data["height"]+'px');
                jQuery('[id="checkoutform_frame_'+messageEvent.data["pop"]+'"]').css('height',messageEvent.data["height"]+'px');
                jQuery('[id="checkoutform_frame_'+messageEvent.data["pop"]+'"]').parent().css('height',messageEvent.data["height"]+'px');
            }
        }
      }
